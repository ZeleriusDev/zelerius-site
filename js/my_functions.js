...
{
    var table = "", myObj;
    var xhr = newCorsXHR("GET","https://raw.githubusercontent.com/ZeleriusDev/zelerius-pool-list/master/pool-list/zelerius-pools.json");
    	...
    	if (xhr.readyState == 4) {
            ...
            var response = xhr.responseText;
                if(response.length != 0)
                {
                    ...
                    table += "</table>";
                    table += "<span style='text-align: right; font-size: 10px; float: right; margin: 10px;'>If you run a pool, please submit a Pull Request on <span class='fab fa-github'> <a href='https://github.com/ZeleriusDev/zelerius-pool-list' target=\'_blank\'>GitHub</a></span></span>";
...
function get_status() {
    ...
    var myObj;
    var xhr = newCorsXHR("POST","http://zls-node:48081/json_rpc");
...
var xhrLiveStats;
var api = "https://pool.zelerius.network:4010";
...
function getMARKET() {
    ...
    var MARKET_URL = "https://explorer.zelerius.network.org/q/market/";
